...
lazy_static::lazy_static! {
    ...
    pub static ref PROD_RENDEZVOUS_SERVER: RwLock<String> = RwLock::new("suporte.facitecfaculdade.com.br".to_owned());
    ...
    pub static ref DEFAULT_SETTINGS: RwLock<HashMap<String, String>> = RwLock::new(HashMap::from([
        ("custom-rendezvous-server".to_string(), "suporte.facitecfaculdade.com.br".to_string()),
        ("relay-server".to_string(), "suporte.facitecfaculdade.com.br".to_string()),
        ("key".to_string(), "odTpR6XvsLZKPDf9frhfosAdjaBh8CAm++pT9ZhzZWA=".to_string()),
    ]));
...
// FACITEC - servidor proprio integrado (Suporte FACITEC)
pub const RENDEZVOUS_SERVERS: &[&str] = &["suporte.facitecfaculdade.com.br"];
pub const RS_PUB_KEY: &str = "odTpR6XvsLZKPDf9frhfosAdjaBh8CAm++pT9ZhzZWA=";
